...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<ErrorDetails> handleException(Exception e, WebRequest webRequest,
                                                         HttpStatus status, Map<String, Object> details) {

        return new ResponseEntity<>(getErrorDetails(e.getMessage(), webRequest, status,
                details), status);
    }

    @ExceptionHandler(NoSuchUserException.class)
    public ResponseEntity<ErrorDetails> handleNoSuchLectureException(NoSuchUserException e,
                                                                     WebRequest webRequest) {

        return handleException(e, webRequest, HttpStatus.NOT_FOUND, Map.of());
    }
